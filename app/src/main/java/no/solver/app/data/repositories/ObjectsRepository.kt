package no.solver.app.data.repositories

import no.solver.app.core.config.AuthEnvironment
import no.solver.app.core.config.AuthProvider
import no.solver.app.core.network.ApiException
import no.solver.app.core.network.ApiResult
import no.solver.app.data.api.ApiClientManager
import no.solver.app.data.models.CommandExecutionRequest
import no.solver.app.data.models.ExecuteResponse
import no.solver.app.data.models.SolverObject
import no.solver.app.features.auth.services.SessionManager
    ...
    suspend fun executeCommand(
        ...
        return ApiResult.runCatching {
            ...
            val locationData = if (latitude != null && longitude != null) {
                no.solver.app.data.models.LocationData(latitude, longitude)
            } else null
